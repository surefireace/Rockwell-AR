        ...
        private Quaternion CalculateDesiredRotation(Vector3 desiredPos)
        {
            ...
            switch (orientationType)
            {
                case SolverOrientationType.YawOnly:
                    ...
                    desiredRot = Quaternion.Euler(SolverHandler.TransformTarget.eulerAngles.x, targetYRotation + 180, 0f); // edit to meet desired outcome [DC]
                    break;
                case SolverOrientationType.YawOnly2:
                    float targetYRotation2 = SolverHandler.TransformTarget != null ? SolverHandler.TransformTarget.eulerAngles.y : 0.0f;
                    desiredRot = Quaternion.Euler(SolverHandler.TransformTarget.eulerAngles.x, targetYRotation2, 0f); // edit to meet desired outcome [DC]
                    break;
